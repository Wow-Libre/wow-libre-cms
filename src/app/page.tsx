...
const Home = () => {
  return (
    <div className="relative overflow-visible bg-midnight">
      ...
      <HomeReveal delayMs={520} fadeOnly>
        <img
          src={HOME_SIDE_SWORD}
      ...
      <HomeReveal delayMs={620} fadeOnly>
        <img
      ...
      <div className="relative z-10 pb-16 md:pb-24">
        ...
        <HomeReveal delayMs={260}>
          <HeroSection />
        </HomeReveal>
        <HomeReveal delayMs={400}>
          <RealmsHome />
        </HomeReveal>
        <HomeReveal delayMs={540}>
          <VotingSlider />
        </HomeReveal>
        <HomeReveal delayMs={680}>
          <ServerFeatures />
        </HomeReveal>
        <HomeReveal delayMs={820}>
          <Bidding />
        </HomeReveal>
        <HomeReveal delayMs={960}>
          <DownloadGame />
        </HomeReveal>
        <HomeReveal delayMs={1100}>
          <Subscription />
        </HomeReveal>
      </div>
