...
type SectionKey = "acceptance" | "use" | "liability" | "changes";

const SECTION_DEFS: { key: SectionKey; number: string }[] = [
  { key: "acceptance", number: "01" },
  { key: "use", number: "02" },
  { key: "liability", number: "03" },
  { key: "changes", number: "04" },
];
...
const IconShield = ({ className = "h-4 w-4" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.4">
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 2l7 3v5c0 4.5-3 7.5-7 8-4-.5-7-3.5-7-8V5l7-3z" />
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-midnight text-slate-200 selection:bg-amber-400/30">
      ...
      <div
        ...
        role="progressbar"
        aria-label={t("terms.ui.sectionProgress")}
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-slate-500">
              ...
              <span className="inline-flex items-center gap-1.5">
                ...
                {t("terms.ui.lastUpdated")}
              </span>
              <span className="hidden h-3 w-px bg-slate-700 sm:block" />
              <span>{t("terms.ui.readTime")}</span>
              <span className="hidden h-3 w-px bg-slate-700 sm:block" />
              <button
                type="button"
                onClick={handlePrint}
            ...
            {SECTION_DEFS.map((s) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="flex-1">{t(`terms.sections.${s.key}.title`)}</span>
                </button>
              );
            })}
          </nav>
                  ...
                  <aside className="lg:sticky lg:top-24 lg:self-start">
                    <div className="border-t border-slate-800 pt-4 lg:border-t-0 lg:border-l lg:pl-5 lg:pt-0">
                      <h3 className="mb-3 text-[10px] font-bold uppercase tracking-[0.22em] text-slate-500">
                        {t("terms.ui.keyPoints")}
                      </h3>
                      <ul className="space-y-2.5">
                        {(t(`terms.sections.${section.key}.points`, {
                          returnObjects: true,
          ...
          <div className="mt-20 border-t border-slate-800 pt-10">
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div className="text-xs text-slate-500">
                ...
                <div className="mt-1">{t("terms.ui.lastUpdated")}</div>
              </div>
              <Link
                href="/"
      ...
      <button
        type="button"
        onClick={scrollTop}
        aria-label={t("terms.ui.backToTop")}
