  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative border-b border-cyan-500/20 px-5 py-5">
        ...
        <div className="space-y-2 p-4 pb-6">
          {paymentMethods.map((method) => (
            <button
              ...
              className="flex w-full items-center gap-3 rounded-2xl border border-cyan-500/15 bg-slate-900/80 px-4 py-4 text-left transition hover:border-cyan-400/40 hover:bg-slate-800"
            >
              <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-cyan-300">
